...
mod 'stdlib',          :git => "#{base_url}/puppetlabs/puppetlabs-stdlib",          :tag => '4.9.0' #SUPPORTED
mod 'vcsrepo',         :git => "#{base_url}/puppetlabs/puppetlabs-vcsrepo",         :tag => '1.3.1' #SUPPORTED
mod 'apt',             :git => "#{base_url}/puppetlabs/puppetlabs-apt",             :tag => '2.1.1' #SUPPORTED
mod 'concat',          :git => "#{base_url}/puppetlabs/puppetlabs-concat",          :tag => '1.2.4' #SUPPORTED
mod 'firewall',        :git => "#{base_url}/puppetlabs/puppetlabs-firewall",        :tag => '1.7.1' #SUPPORTED
mod 'apache',          :git => "#{base_url}/puppetlabs/puppetlabs-apache",          :tag => '1.6.0' #SUPPORTED
mod 'inifile',         :git => "#{base_url}/puppetlabs/puppetlabs-inifile",         :tag => '1.4.2' #SUPPORTED
mod 'mysql',           :git => "#{base_url}/puppetlabs/puppetlabs-mysql",           :tag => '3.6.0' #SUPPORTED
mod 'postgresql',      :git => "#{base_url}/puppetlabs/puppetlabs-postgresql",      :tag => '4.6.0' #SUPPORTED
mod 'ntp',             :git => "#{base_url}/puppetlabs/puppetlabs-ntp",             :tag => '4.1.0' #SUPPORTED
mod 'java',            :git => "#{base_url}/puppetlabs/puppetlabs-java",            :tag => '1.4.1' #SUPPORTED
mod 'haproxy',         :git => "#{base_url}/puppetlabs/puppetlabs-haproxy",         :tag => '1.3.0' #SUPPORTED
mod 'java_ks',         :git => "#{base_url}/puppetlabs/puppetlabs-java_ks",         :tag => '1.3.1' #SUPPORTED
mod 'registry',        :git => "#{base_url}/puppetlabs/puppetlabs-registry",        :tag => '1.1.2' #SUPPORTED #WINDOWS
mod 'tomcat',          :git => "#{base_url}/puppetlabs/puppetlabs-tomcat",          :tag => '1.3.2' #SUPPORTED
mod 'powershell',      :git => "#{base_url}/puppetlabs/puppetlabs-powershell",      :tag => '1.0.5' #SUPPORTED #WINDOWS
mod 'reboot',          :git => "#{base_url}/puppetlabs/puppetlabs-reboot",          :tag => '1.1.0' #SUPPORTED #WINDOWS
mod 'acl',             :git => "#{base_url}/puppetlabs/puppetlabs-acl",             :tag => '1.1.1' #SUPPORTED #WINDOWS
mod 'aws',             :git => "#{base_url}/puppetlabs/puppetlabs-aws",             :tag => '1.1.1' #SUPPORTED
mod 'tagmail',         :git => "#{base_url}/puppetlabs/puppetlabs-tagmail",         :tag => '2.1.0' #SUPPORTED
...
mod 'erlang',        :git => "#{base_url}/garethr/garethr-erlang", :tag => 'v0.3.0' #APPROVED
...
mod 'augeasproviders_shellvar',   :git => "#{base_url}/hercules-team/augeasproviders_shellvar",     :tag => '2.2.0' #APPROVED
...
mod 'wget',        :git => "#{base_url}/maestrodev/puppet-wget", :tag => 'v1.7.0'  #APPROVED 
mod 'python',        :git => "#{base_url}/stankevich/puppet-python", :tag => '1.9.4' #APPROVED
mod 'r10k',         :git => "#{base_url}/acidprime/r10k", :tag => 'v3.1.1' #APPROVED
